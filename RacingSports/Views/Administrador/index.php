...
<head>
    ...
    <link rel="stylesheet" href="../Views/Estilos/index.css">
...
<body>
    <div class="container-fluid">
      ...
      <!-- crear un titulo de bienvenida al usuario -->
    ...
    <div class="container-title">
        <h3 style="text-align: center;">BIENVENID@ A
            RACING SPORTS MOTORS.</h3>
        </div>
        <div class="container-img">
            <img class="imagen" src="/Views/imagenes/imagen2.png">
        </div>
      </section>
</body>
</html>
